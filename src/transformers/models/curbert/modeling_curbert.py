...
from .configuration_curbert import CURBertConfig
...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if relative_position_scores is not None:
            nc, c_index, c_bias = self.func_k_select(
        ...
        nr, r_index, r_bias = self.func_q_select(
        ...
        kernel_2 = self.func_u_select(kernel_1, r_index)
